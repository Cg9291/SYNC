 ...
 export const Keys=forwardRef((props,btnRef)=>(
        <div>
            <div className="row-cols-4 justify-content">
                ...
                <button id="divide" className="col-3 btn btn-primary shadow-none rounded-0 border" value={'/'} onClick={props.handleClickOperator}>/</button>
                <button id="multiply" className="col-3 btn btn-primary shadow-none rounded-0 border" value={'x'} onClick={props.handleClickOperator}>x</button>
            </div>
            <div className="row-cols-4  justify-content">
                ...
                <button id="subtract" className="col-3 btn btn-primary shadow-none rounded-0 border" value={'-'} onClick={props.handleClickOperator}>-</button>
            </div>
            <div className="row-cols-4 justify-content">
                ...
                <button id="add" className="col-3 btn btn-primary shadow-none rounded-0 border" value={'+'} onClick={props.handleClickOperator}>+</button>
            </div>
            <div className="row-cols-4 justify-content">
