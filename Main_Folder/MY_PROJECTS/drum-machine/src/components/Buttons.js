    ...
    return(
        <div className="container-fluid justify-content-center align-items-center">
            ...
            <div id="pad" className="col-4 row-cols-3" style={{border:'solid blue'}}> 
                <button id="Clap" className="drum-pad col btn btn-dark" onClick={playSound}>
                    Q
                ...
                <button id="Closed HH" className="drum-pad col btn btn-dark" onClick={playSound}>
                    W
                ...
                <button id="Heater 1" className="drum-pad col btn btn-dark" onClick={playSound}>
                    E
                ...
                <button id="Heater 2" className="drum-pad col btn btn-dark" onClick={playSound}>
                    A
                ...
                <button id="Heater 3" className="drum-pad col-4 btn btn-dark" onClick={playSound}>
                    S
                ...
                <button id="Heater 4" className="drum-pad col btn btn-dark" onClick={playSound}>
                    D
                ...
                <button id="Kick n'Hat" className="drum-pad col btn btn-dark" onClick={playSound}>
                    Z
                ...
                <button id="Kick" className="drum-pad col btn btn-dark" onClick={playSound}>
                    X
                ...
                <button id="Open HH" className="drum-pad col btn btn-dark" onClick={playSound}>
                    C
